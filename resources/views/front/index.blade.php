                        ...
                        @foreach($units as $unit)
                            ...
                            <div class="property-item">
                                <div class="property--img">
                                    <a href="#">
                            <img src="" alt="property image" class="img-responsive">
                            <span class="property--status">For Sale</span>
</a>
                                </div>
                                <div class="property--content">
                                    <div class="property--info">
                                        <h5 class="property--title"><a href="#">{{$unit->title}}</a></h5>
                                        <p class="property--location">{{$unit->city->name}}</p>
                                    ...
                                    <div class="property--features">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li><span class="feature">Area:</span><span class="feature-num">{{$unit->area}}</span></li>
                                            <li><span class="feature">Owner:</span><span class="feature-num">{{ $unit->user->name}}</span></li>
                                        </ul>
                                    </div>
